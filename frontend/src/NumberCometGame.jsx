...
import FindingLeftoversGame from './FindingLeftoversGame';
...
import TeenTowerGame from './TeenTowerGame';
import HoneybeeHiveGame from './HoneybeeHiveGame';
import AstromazeRocketGame from './AstromazeRocketGame';
import TeenBreakdownGame from './TeenBreakdownGame';
import DiceFlashGame from './DiceFlashGame';
import DominosFlashGame from './DominosFlashGame';
import TrainStationGame from './TrainStationGame';
import ToySoldierMarchGame from './ToySoldierMarchGame';
import CosmicStarBridgeGame from './CosmicStarBridgeGame';
import GridRunnerGame from './GridRunnerGame';
...
export default function NumberCometGame({ userId, onExit }) {
  ...
  const renderAsset = () => {
    ...
    if (currentQuestion.type === 'finding_leftovers_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <FindingLeftoversGame 
              key={currentQuestionIndex}
              dataStr={currentQuestion.asset} 
              onCorrectSound={() => playFeedbackTone('correct', volume)}
              onErrorSound={() => playFeedbackTone('wrong', volume)}
    ...
    if (currentQuestion.type === 'number_comparison_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
    ...
    if (currentQuestion.type === 'fairness_adjuster_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <FairnessAdjusterGame 
              key={currentQuestionIndex}
              dataStr={currentQuestion.asset} 
              onCorrectSound={() => playFeedbackTone('correct', volume)}
              onVictory={() => {
                 setTraceCompleted(true);
                 setTimeout(progressToNext, 2000); // slightly longer delay for confetti to settle
              }} 
           />
        </div>
      );
    }
    if (currentQuestion.type === 'estimation_blitz_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <EstimationBlitzGame 
              key={currentQuestionIndex}
              ...
              onVictory={() => {
                 setTraceCompleted(true);
                 setTimeout(progressToNext, 2000); 
              }} 
           />
        </div>
      );
    }
    if (currentQuestion.type === 'ten_frame_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <TenFrameGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'base_10_anchor_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <Base10AnchorGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'number_castle_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <NumberCastleGame 
              key={currentQuestionIndex}
              ...
              onVictory={() => {
                 setTraceCompleted(true);
                 setTimeout(progressToNext, 3500); 
              }} 
           />
        </div>
      );
    }
    if (currentQuestion.type === 'teen_tower_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <TeenTowerGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'honeybee_hive_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <HoneybeeHiveGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'astromaze_rocket_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <AstromazeRocketGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'teen_breakdown_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <TeenBreakdownGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'dice_flash_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <DiceFlashGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'dominos_flash_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <DominosFlashGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'train_station_game') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <TrainStationGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'toy_soldier_march') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <ToySoldierMarchGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'cosmic_star_bridge') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <CosmicStarBridgeGame 
              key={currentQuestionIndex}
              dataStr={currentQuestion.assetValue || currentQuestion.asset}
              onVictory={() => {
                 setTraceCompleted(true);
    ...
    if (currentQuestion.type === 'grid_runner') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <GridRunnerGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'forest_path_rescue') {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: '300px' }}>
           <ForestPathRescueGame 
              key={currentQuestionIndex}
    ...
    if (currentQuestion.type === 'retro_rocket_game') {
      return (
